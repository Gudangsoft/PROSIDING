...
<head>
    ...
    ?>
    <title><?php echo $__env->yieldContent('title', $appSiteName); ?></title>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($appFavicon): ?>
    <link rel="icon" type="image/png" href="<?php echo e(asset('storage/' . $appFavicon)); ?>">
    ...
    <style>
        ...
        /* Theme CSS Variables */
        <?php echo \App\Models\ThemePreset::getActive()?->toCssVariables() ?? \App\Models\ThemePreset::defaultCssVariables(); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(\App\Models\ThemePreset::getActive()?->custom_css): ?>
    <style><?php echo \App\Models\ThemePreset::getActive()->custom_css; ?></style>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<body class="bg-gray-100 min-h-screen" x-data="{ sidebarOpen: false }">
    ...
    <div class="bg-yellow-500 text-yellow-900 text-center py-2 px-4 text-sm font-medium z-[100] relative">
        <div class="flex items-center justify-center gap-3">
            ...
            <span>Anda sedang login sebagai <strong><?php echo e(Auth::user()->name); ?></strong> (<?php echo e(ucfirst(Auth::user()->role)); ?>)</span>
            <form method="POST" action="<?php echo e(route('admin.stop-impersonate')); ?>" class="inline">
                <?php echo csrf_field(); ?>
    ...
    <div class="flex min-h-screen">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="flex items-center justify-between <?php echo e(($showTagline === '1' && $appTagline) ? 'py-3' : 'h-16'); ?> px-5 border-b sidebar-logo-border shrink-0">
                <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-2 min-w-0">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($appSiteLogo): ?>
                    <img src="<?php echo e(asset('storage/' . $appSiteLogo)); ?>" alt="Logo" class="w-8 h-8 object-contain rounded-lg shrink-0">
                    <?php else: ?>
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <div class="min-w-0">
                        <span class="text-lg font-bold sidebar-name block truncate"><?php echo e($appSiteName); ?></span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showTagline === '1' && $appTagline): ?>
                        <span class="text-[11px] sidebar-tagline leading-tight block truncate"><?php echo e($appTagline); ?></span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </a>
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
                ...
                <a href="<?php echo e(route('dashboard')); ?>"
                   ...
                   <?php echo e(request()->routeIs('dashboard') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                ...
                <a href="<?php echo e(route('helpdesk')); ?>"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                   <?php echo e(request()->routeIs('helpdesk*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->isParticipant()): ?>
                <div class="pt-4">
                    ...
                    <a href="<?php echo e(route('participant.payment')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('participant.payment') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                    ...
                    <a href="<?php echo e(route('participant.info')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('participant.info') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        Informasi
                    </a>
                    <a href="<?php echo e(route('participant.materials')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('participant.materials') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>
                        Materi &amp; Sertifikat
                    </a>
                    <a href="<?php echo e(url('/publikasi')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->is('publikasi*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                        Publikasi
                    </a>
                </div>
                ...
                <div class="pt-4">
                    ...
                    <a href="<?php echo e(route('author.papers')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('author.papers') || request()->routeIs('author.paper.detail') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        Paper Saya
                    </a>
                    <a href="<?php echo e(route('author.submit')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('author.submit') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                    ...
                    <a href="<?php echo e(route('author.loa')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('author.loa') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                ...
                <div class="pt-4">
                    ...
                    <a href="<?php echo e(route('reviewer.reviews')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('reviewer.*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                ...
                <div class="pt-4">
                    ...
                    <a href="<?php echo e(route('admin.papers')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('admin.papers') || request()->routeIs('admin.paper.*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                        ...
                        Kelola Paper
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sidebarPaperBadge > 0): ?><span class="ml-auto bg-red-500 text-white text-xs font-bold rounded-full px-1.5 py-0.5 min-w-[1.25rem] text-center leading-none"><?php echo e($sidebarPaperBadge); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </a>
                    <a href="<?php echo e(route('admin.payments')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('admin.payments') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                        ...
                        Pembayaran
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sidebarPaymentBadge > 0): ?><span class="ml-auto bg-orange-500 text-white text-xs font-bold rounded-full px-1.5 py-0.5 min-w-[1.25rem] text-center leading-none"><?php echo e($sidebarPaymentBadge); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </a>
                    <a href="<?php echo e(route('admin.materials')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('admin.materials') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>
                        Kelola Materi
                    </a>
                    <a href="<?php echo e(route('admin.conferences')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('admin.conferences*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                ...
                <div class="pt-4">
                    ...
                    <a href="<?php echo e(route('admin.news')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('admin.news*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                    ...
                    <a href="<?php echo e(route('admin.pages')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('admin.pages*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        Halaman
                    </a>
                    <a href="<?php echo e(route('admin.announcements')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('admin.announcements*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z"/></svg>
                        Pengumuman
                    </a>
                    <a href="<?php echo e(route('admin.sliders')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('admin.sliders*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                    ...
                    <a href="<?php echo e(route('admin.menus')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('admin.menus*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                    ...
                    <a href="<?php echo e(route('admin.supporters')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('admin.supporters*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                ...
                <div class="pt-4">
                    ...
                    <a href="<?php echo e(route('admin.helpdesk')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('admin.helpdesk*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                        Helpdesk
                    </a>
                    <a href="<?php echo e(route('admin.users-roles')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('admin.users-roles') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                ...
                <div class="pt-4">
                    ...
                    <a href="<?php echo e(route('admin.settings.general')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('admin.settings.general') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                    ...
                    <a href="<?php echo e(route('admin.settings.email')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('admin.settings.email') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                    ...
                    <a href="<?php echo e(route('admin.settings.theme')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('admin.settings.theme') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
            ...
            <div class="border-t p-4 shrink-0 sidebar-logo-border">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <img src="<?php echo e(asset('storage/' . Auth::user()->photo)); ?>" class="w-9 h-9 rounded-full object-cover shrink-0">
                    <?php else: ?>
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <div class="min-w-0">
                        <p class="text-sm font-medium sidebar-name truncate"><?php echo e(Auth::user()->name); ?></p>
                        <span class="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-semibold
                            <?php if(Auth::user()->role==='admin'): ?> bg-red-100 text-red-700
                            <?php elseif(Auth::user()->role==='editor'): ?> bg-purple-100 text-purple-700
                            <?php elseif(Auth::user()->role==='reviewer'): ?> bg-indigo-100 text-indigo-700
                            <?php elseif(Auth::user()->role==='participant'): ?> bg-teal-100 text-teal-700
                            <?php else: ?> bg-blue-100 text-blue-700 <?php endif; ?>">
                            <?php echo e(Auth::user()->role === 'participant' ? 'Partisipan' : ucfirst(Auth::user()->role)); ?>

                        </span>
                    </div>
                </div>
                <a href="<?php echo e(route('profile')); ?>" class="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-100 transition mb-1">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                    Edit Profil
                </a>
                <form method="POST" action="<?php echo e(route('logout')); ?>" wire:ignore>
                    <?php echo csrf_field(); ?>
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 lg:px-6 shrink-0">
                ...
                <div class="hidden lg:block">
                    <h1 class="text-lg font-semibold text-gray-800"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h1>
                </div>
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-sm text-gray-500 hidden sm:inline"><?php echo e(Auth::user()->email); ?></span>
                </div>
            </header>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($appSiteLogo): ?>
                    <img src="<?php echo e(asset('storage/' . $appSiteLogo)); ?>" alt="Logo" class="w-8 h-8 object-contain rounded-lg">
                    <?php else: ?>
                    <div class="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <span class="text-xl font-bold text-gray-800"><?php echo e($appSiteName); ?></span>
                </a>
                <div class="flex items-center space-x-3">
                    <a href="<?php echo e(route('login')); ?>" class="text-sm text-blue-600 hover:text-blue-800 font-medium">Login</a>
                    <a href="<?php echo e(route('register')); ?>" class="text-sm bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">Register</a>
                </div>
            </div>
        </div>
    </nav>
                        ...
                        <div class="flex items-start gap-4 p-4 rounded-xl border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 transition group">
                            <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center shrink-0 group-hover:scale-110 transition">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($tutorial['icon']); ?>"/>
                                </svg>
                            </div>
                            <div class="flex-1">
                                <h3 class="font-semibold text-gray-900 mb-1"><?php echo e($tutorial['title']); ?></h3>
                                <p class="text-sm text-gray-600 leading-relaxed"><?php echo e($tutorial['desc']); ?></p>
                            </div>
                        </div>
...
<?php /**PATH D:\LPKD-APJI\PROSIDING\resources\views/layouts/app.blade.php ENDPATH**/ ?>