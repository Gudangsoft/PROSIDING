        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-0 md:divide-x divide-gray-200">
                ...
                <div class="flex items-start gap-5 px-6 py-4 md:pr-8">
                    ...
                    <div>
                        <h3 class="text-base font-extrabold text-gray-700 uppercase tracking-wider mb-3"><?php echo e(__('welcome.info.tanggal_penting')); ?></h3>
                        ...
                        <ul class="space-y-1.5 text-sm text-gray-600">
                            ...
                            <li class="<?php echo e($date->is_past ? 'line-through text-gray-400' : ''); ?>">
                                <span class="font-medium text-gray-700"><?php echo e($date->title); ?></span> :
                                <span class="text-red-600 font-semibold"><?php echo e($date->date?->translatedFormat('d F Y') ?? '-'); ?></span>
                            </li>
                ...
                <div class="flex items-start gap-5 px-6 py-4 md:px-8 border-t md:border-t-0">
                    ...
                    <div>
                        <h3 class="text-base font-extrabold text-gray-700 uppercase tracking-wider mb-3"><?php echo e(__('welcome.info.publikasi_prosiding')); ?></h3>
                ...
                <div class="flex items-start gap-5 px-6 py-4 md:pl-8 border-t md:border-t-0">
                    ...
                    <div>
                        <h3 class="text-base font-extrabold text-gray-700 uppercase tracking-wider mb-3"><?php echo e(__('welcome.info.makalah_terpilih')); ?></h3>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?><?php /**PATH D:\LPKD-APJI\PROSIDING\resources\views/templates/default-blue/sections/info-cards.blade.php ENDPATH**/ ?>