...
<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-start justify-between mb-4">
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeConference->theme): ?><p class="text-sm text-gray-500 mt-1"><?php echo e($activeConference->theme); ?></p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeConference->meeting_link): ?>
                    <div class="mt-2">
                        <a href="<?php echo e($activeConference->meeting_link); ?>" target="_blank" class="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->isTreasurer()): ?>
    <?php
        $pendingPayments = \App\Models\Payment::where('status', 'uploaded')->count();
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-5 border text-center">
            <p class="text-2xl font-bold text-green-600"><?php echo e($verifiedPayments); ?></p>
        ...
        <div class="bg-white rounded-xl shadow-sm p-5 border text-center">
            <p class="text-2xl font-bold text-blue-600"><?php echo e($todayPayments); ?></p>
            <p class="text-xs text-gray-500 mt-1">Hari Ini</p>
        </div>
        <div class="bg-white rounded-xl shadow-sm p-5 border text-center">
            <p class="text-2xl font-bold text-indigo-600"><?php echo e($weekPayments); ?></p>
            <p class="text-xs text-gray-500 mt-1">Minggu Ini</p>
        </div>
        <div class="bg-white rounded-xl shadow-sm p-5 border text-center">
            <p class="text-2xl font-bold text-purple-600"><?php echo e($monthPayments); ?></p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div class="bg-white rounded-xl shadow-sm p-6 border">
            <h2 class="text-lg font-semibold text-gray-800 mb-4">Aksi Cepat</h2>
            <div class="space-y-3">
                <a href="<?php echo e(route('treasurer.payments')); ?>" class="flex items-center p-3 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition">
                    <svg class="w-6 h-6 text-emerald-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                    <div><p class="font-medium text-sm text-gray-800">Verifikasi Pembayaran</p><p class="text-xs text-gray-500"><?php echo e($pendingPayments); ?> pembayaran menunggu verifikasi</p></div>
                </a>
                <a href="<?php echo e(route('treasurer.reports')); ?>" class="flex items-center p-3 bg-teal-50 rounded-lg hover:bg-teal-100 transition">
                ...
                <a href="<?php echo e(route('treasurer.reports.revenue')); ?>" class="flex items-center p-3 bg-cyan-50 rounded-lg hover:bg-cyan-100 transition">
        ...
        <div class="bg-white rounded-xl shadow-sm border overflow-hidden">
            <div class="px-6 py-4 border-b flex items-center justify-between">
                ...
                <a href="<?php echo e(route('treasurer.payments')); ?>" class="text-emerald-600 text-xs font-medium">Lihat Semua</a>
            </div>
            <?php $recentPayments = \App\Models\Payment::with('user')->latest()->take(5)->get(); ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentPayments->count()): ?>
            <div class="divide-y">
                ...
                <div class="px-6 py-3 flex justify-between items-center hover:bg-gray-50">
                    <div>
                        <p class="text-sm font-medium text-gray-800"><?php echo e($payment->user?->name ?? 'N/A'); ?></p>
                        <p class="text-xs text-gray-400">Rp <?php echo e(number_format($payment->amount, 0, ',', '.')); ?> &bull; <?php echo e($payment->created_at?->diffForHumans()); ?></p>
                    </div>
                    <span class="text-xs px-2 py-1 rounded-full <?php echo e($payment->status === 'verified' ? 'bg-green-100 text-green-700' : ($payment->status === 'uploaded' ? 'bg-orange-100 text-orange-700' : 'bg-gray-100 text-gray-600')); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\LPKD-APJI\PROSIDING\resources\views/dashboard.blade.php ENDPATH**/ ?>