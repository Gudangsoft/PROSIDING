...
<head>
    ...
    <title>@yield('title', \App\Models\Setting::getValue('site_name', config('app.name', 'Prosiding')))</title>
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
                ...
                <a href="{{ route('dashboard') }}"
                   ...
                   {{ request()->routeIs('dashboard') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-md shadow-blue-200' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}">
                    <div class="{{ request()->routeIs('dashboard') ? 'bg-white/20' : 'bg-blue-100' }} p-2 rounded-lg">
                ...
                {{-- Pemakalah Menu (Author) - Gabungan menu paper & abstrak --}}
                ...
                <div class="pt-5">
                    ...
                    <a href="{{ route('author.papers') }}"
                       ...
                       {{ request()->routeIs('author.papers') || request()->routeIs('author.paper.detail') ? 'bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-md shadow-indigo-200' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 hover:translate-x-1' }}">
                        <div class="{{ request()->routeIs('author.papers') || request()->routeIs('author.paper.detail') ? 'bg-white/20' : 'bg-indigo-100' }} p-2 rounded-lg">
                    ...
                    <a href="{{ route('author.submit') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 mb-1
                       {{ request()->routeIs('author.submit') ? 'bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-md shadow-emerald-200' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 hover:translate-x-1' }}">
                        <div class="{{ request()->routeIs('author.submit') ? 'bg-white/20' : 'bg-emerald-100' }} p-2 rounded-lg">
                            <svg class="w-5 h-5 {{ request()->routeIs('author.submit') ? 'text-white' : 'text-emerald-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/></svg>
                        </div>
                        Submit Paper
                    </a>
                    
                    {{-- Abstrak Saya --}}
                    <a href="{{ route('author.abstracts') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 mb-1
                       {{ request()->routeIs('author.abstracts') ? 'bg-gradient-to-r from-violet-500 to-purple-500 text-white shadow-md shadow-violet-200' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 hover:translate-x-1' }}">
                        <div class="{{ request()->routeIs('author.abstracts') ? 'bg-white/20' : 'bg-violet-100' }} p-2 rounded-lg">
                    ...
                    {{-- Submit Abstrak --}}
                    <a href="{{ route('author.abstract.create') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 mb-1
                       {{ request()->routeIs('author.abstract.create') ? 'bg-gradient-to-r from-cyan-500 to-blue-500 text-white shadow-md shadow-cyan-200' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 hover:translate-x-1' }}">
                        <div class="{{ request()->routeIs('author.abstract.create') ? 'bg-white/20' : 'bg-cyan-100' }} p-2 rounded-lg">
                            <svg class="w-5 h-5 {{ request()->routeIs('author.abstract.create') ? 'text-white' : 'text-cyan-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        </div>
                        Submit Abstrak
                    </a>
                    ...
                    <a href="{{ route('author.loa') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 mb-1
                       {{ request()->routeIs('author.loa') ? 'bg-gradient-to-r from-amber-500 to-orange-500 text-white shadow-md shadow-amber-200' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 hover:translate-x-1' }}">
                        <div class="{{ request()->routeIs('author.loa') ? 'bg-white/20' : 'bg-amber-100' }} p-2 rounded-lg">
                    ...
                    {{-- Sertifikat Saya --}}
                    <a href="{{ route('author.certificates') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 mb-1
                       {{ request()->routeIs('author.certificates*') ? 'bg-gradient-to-r from-yellow-500 to-amber-500 text-white shadow-md shadow-yellow-200' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 hover:translate-x-1' }}">
                        <div class="{{ request()->routeIs('author.certificates*') ? 'bg-white/20' : 'bg-yellow-100' }} p-2 rounded-lg">
                    ...
                    <a href="{{ route('participant.materials') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 mb-1
                       {{ request()->routeIs('participant.materials') ? 'bg-gradient-to-r from-rose-500 to-pink-500 text-white shadow-md shadow-rose-200' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 hover:translate-x-1' }}">
                        <div class="{{ request()->routeIs('participant.materials') ? 'bg-white/20' : 'bg-rose-100' }} p-2 rounded-lg">
                ...
                {{-- Peserta Menu (hanya untuk Participant murni, bukan Author) --}}
                @if(Auth::user()->isParticipant() && !Auth::user()->isAuthor())
                <div class="pt-5">
                    <p class="px-3 mb-3 text-xs font-bold text-gray-400 uppercase tracking-wider flex items-center gap-2">
                    ...
                    <a href="{{ route('participant.info') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 mb-1
                       {{ request()->routeIs('participant.info') ? 'bg-gradient-to-r from-teal-500 to-cyan-500 text-white shadow-md shadow-teal-200' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 hover:translate-x-1' }}">
                        <div class="{{ request()->routeIs('participant.info') ? 'bg-white/20' : 'bg-teal-100' }} p-2 rounded-lg">
                            <svg class="w-5 h-5 {{ request()->routeIs('participant.info') ? 'text-white' : 'text-teal-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                        </div>
                        Info Peserta
                    </a>
                    <a href="{{ route('author.abstracts') }}"
                    ...
                    <a href="{{ route('participant.payment') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 mb-1
                       {{ request()->routeIs('participant.payment') ? 'bg-gradient-to-r from-green-500 to-emerald-500 text-white shadow-md shadow-green-200' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 hover:translate-x-1' }}">
                        <div class="{{ request()->routeIs('participant.payment') ? 'bg-white/20' : 'bg-green-100' }} p-2 rounded-lg">
                            <svg class="w-5 h-5 {{ request()->routeIs('participant.payment') ? 'text-white' : 'text-green-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/></svg>
                        </div>
                        Pembayaran
                    </a>
                </div>
                ...
                <div class="pt-5">
                    ...
                    <a href="{{ route('reviewer.reviews') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 mb-1
                       {{ request()->routeIs('reviewer.*') ? 'bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-md shadow-orange-200' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 hover:translate-x-1' }}">
                        <div class="{{ request()->routeIs('reviewer.*') ? 'bg-white/20' : 'bg-orange-100' }} p-2 rounded-lg">
                ...
                <div class="pt-5">
                    ...
                    <a href="{{ route('treasurer.payments') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 mb-1
                       {{ request()->routeIs('treasurer.payments') ? 'bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-md shadow-emerald-200' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 hover:translate-x-1' }}">
                        <div class="{{ request()->routeIs('treasurer.payments') ? 'bg-white/20' : 'bg-emerald-100' }} p-2 rounded-lg">
                        ...
                        @if(isset($sidebarPendingPayments) && $sidebarPendingPayments > 0)
                            <span class="ml-auto bg-white text-emerald-600 text-xs font-bold px-2 py-0.5 rounded-full">{{ $sidebarPendingPayments }}</span>
                        @endif
                    </a>
                    <a href="{{ route('treasurer.reports') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 mb-1
                       {{ request()->routeIs('treasurer.reports*') ? 'bg-gradient-to-r from-teal-500 to-cyan-500 text-white shadow-md shadow-teal-200' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 hover:translate-x-1' }}">
                        <div class="{{ request()->routeIs('treasurer.reports*') ? 'bg-white/20' : 'bg-teal-100' }} p-2 rounded-lg">
                ...
                <div class="pt-5">
                    ...
                    <a href="{{ route('admin.papers') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 mb-1
                       {{ request()->routeIs('admin.papers') || request()->routeIs('admin.paper.*') ? 'bg-gradient-to-r from-purple-500 to-indigo-500 text-white shadow-md shadow-purple-200' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 hover:translate-x-1' }}">
                        <div class="{{ request()->routeIs('admin.papers') || request()->routeIs('admin.paper.*') ? 'bg-white/20' : 'bg-purple-100' }} p-2 rounded-lg">
                            <svg class="w-5 h-5 {{ request()->routeIs('admin.papers') || request()->routeIs('admin.paper.*') ? 'text-white' : 'text-purple-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg>
                        </div>
                        Kelola Paper
                        @if(isset($sidebarPendingPapers) && $sidebarPendingPapers > 0)
                            <span class="ml-auto bg-white text-purple-600 text-xs font-bold px-2 py-0.5 rounded-full">{{ $sidebarPendingPapers }}</span>
                        @endif
                    </a>
                    <a href="{{ route('admin.payments') }}"
                       ...
                       {{ request()->routeIs('admin.payments') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        ...
                        Pembayaran
                        @if(isset($sidebarPendingPayments) && $sidebarPendingPayments > 0)
                            <span class="ml-auto bg-orange-500 text-white text-xs font-bold px-2 py-0.5 rounded-full">{{ $sidebarPendingPayments }}</span>
                        @endif
                    </a>
                ...
                <div class="pt-4">
                    ...
                    <a href="{{ route('admin.papers') }}"
                       ...
                       {{ request()->routeIs('admin.papers') || request()->routeIs('admin.paper.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        ...
                        Kelola Paper
                        @if(isset($sidebarPendingPapers) && $sidebarPendingPapers > 0)
                            <span class="ml-auto bg-blue-600 text-white text-xs font-bold px-2 py-0.5 rounded-full">{{ $sidebarPendingPapers }}</span>
                        @endif
                    </a>
                    <a href="{{ route('admin.payments') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                    ...
                    <a href="{{ route('admin.abstracts') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       {{ request()->routeIs('admin.abstracts') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        ...
                        Kelola Abstrak
                        @if(isset($sidebarPendingAbstracts) && $sidebarPendingAbstracts > 0)
                            <span class="ml-auto bg-yellow-500 text-white text-xs font-bold px-2 py-0.5 rounded-full">{{ $sidebarPendingAbstracts }}</span>
                        @endif
                    </a>
                    <a href="{{ route('admin.auto-reviewer') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       {{ request()->routeIs('admin.auto-reviewer') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                    ...
                    <a href="{{ route('admin.camera-ready') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       {{ request()->routeIs('admin.camera-ready') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                        Camera-Ready
                        @if(isset($sidebarPendingCameraReady) && $sidebarPendingCameraReady > 0)
                            <span class="ml-auto bg-purple-500 text-white text-xs font-bold px-2 py-0.5 rounded-full">{{ $sidebarPendingCameraReady }}</span>
                        @endif
                    </a>
                    <a href="{{ route('admin.revisions') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       {{ request()->routeIs('admin.revisions') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        ...
                        Revision Manager
                        @if(isset($sidebarRevisedPapers) && $sidebarRevisedPapers > 0)
                            <span class="ml-auto bg-cyan-500 text-white text-xs font-bold px-2 py-0.5 rounded-full">{{ $sidebarRevisedPapers }}</span>
                        @endif
                    </a>
                    <a href="{{ route('admin.analytics') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       {{ request()->routeIs('admin.analytics') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                    ...
                    <a href="{{ route('admin.review-rubrics') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       {{ request()->routeIs('admin.review-rubrics') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                    ...
                    <a href="{{ route('admin.paper-similarity') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       {{ request()->routeIs('admin.paper-similarity') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2"/></svg>
                        Cek Kemiripan Paper
                    </a>
                    <a href="{{ route('admin.stats') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       {{ request()->routeIs('admin.stats') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                        Statistik
                    </a>
                    <a href="{{ route('admin.certificates') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       {{ request()->routeIs('admin.certificates') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/></svg>
                        Sertifikat
                    </a>
                    <a href="{{ route('admin.broadcast') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       {{ request()->routeIs('admin.broadcast') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                    ...
                    <a href="{{ route('admin.reports') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       {{ request()->routeIs('admin.reports') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3M3 17V7a2 2 0 012-2h6l2 2h6a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2z"/></svg>
                        Export Laporan
                    </a>
                    <a href="{{ route('admin.program-book') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       {{ request()->routeIs('admin.program-book') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                        Program Book PDF
                    </a>
                </div>
                ...
                <div class="pt-4">
                    ...
                    <a href="{{ route('admin.submission-fields') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       {{ request()->routeIs('admin.submission-fields') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                    ...
                    <a href="{{ route('admin.page-builder') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       {{ request()->routeIs('admin.page-builder') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"/></svg>
                        Page Builder
                    </a>
                    <a href="{{ route('admin.ojs') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       {{ request()->routeIs('admin.ojs') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                ...
                <div class="pt-4">
                    ...
                    <a href="{{ route('admin.whatsapp') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       {{ request()->routeIs('admin.whatsapp') ? 'bg-green-50 text-green-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <a href="{{ url('/') }}" class="flex items-center gap-2">
                    ...
                    <span class="text-xl font-bold text-gray-800">{{ \App\Models\Setting::getValue('site_name', config('app.name', 'Prosiding')) }}</span>
                </a>
