        ...
        <div class="flex items-center gap-3 mb-4 pb-3 border-b-2 border-teal-100">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500">
                    ...
                    <div class="mt-2">
                        <a href="{{ $conference->meeting_link }}" target="_blank" class="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-600 text-white rounded-lg text-xs font-medium hover:bg-blue-700 transition">
