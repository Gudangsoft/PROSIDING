    ...
    <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-lg mx-4">
            ...
            <div class="p-5 space-y-4">
                ...
                {{-- Auto-detected package info --}}
                @if($detectedPackageName)
                <div class="bg-teal-50 border border-teal-200 rounded-lg p-3 flex items-center gap-2">
                    ...
                    <div>
                        <p class="text-xs font-semibold text-teal-800">Paket terdeteksi dari registrasi peserta:</p>
                        <p class="text-sm font-bold text-teal-900">{{ $detectedPackageName }}</p>
                    </div>
                </div>
                @endif
